...
interface DeviceMenuOptions {
    ...
    onResetClicked: () => void;
    onMarkDefaultClicked: () => void;
}

export class ExpandableDeviceMenuItem extends PopupSubMenuMenuItem {
    private _boxed: St.BoxLayout;
    private _icon: St.Icon;
    private _nameLabel: St.Label;
    private _speedLabel: St.Label;
    private _dataLabel: St.Label;
    private _ipTitleLabel: St.Label;
    private _ipValueLabel: St.Label;
    private _uploadSpeedTitleLabel: St.Label;
    private _uploadSpeedValueLabel: St.Label;
    private _downloadSpeedTitleLabel: St.Label;
    private _downloadSpeedValueLabel: St.Label;
    private _totalSpeedTitleLabel: St.Label;
    private _totalSpeedValueLabel: St.Label;
    private _totalDataTitleLabel: St.Label;
    private _totalDataValueLabel: St.Label;
    private _lastResetedTitleLabel: St.Label;
    private _lastResetedValueLabel: St.Label;
    private _resetButton: St.Button;
